...
Group.new("Structure", colors.dark_blue, nil, styles.NONE)
...
Group.new("Keyword", colors.light_blue, nil, styles.NONE)
Group.new("Label", colors.yellow, nil, nil)
Group.new("Operator", colors.dark_blue, nil, styles.NONE)
Group.new("Exception", colors.light_pink, nil, styles.NONE)
Group.new("PreProc", colors.dark_orange, nil, nil)
Group.new("Include", colors.dark_pink, nil, styles.NONE)
Group.new("Define", colors.dark_orange, nil, styles.NONE)
...
Group.new("Debug", colors.light_green, nil, styles.NONE)
